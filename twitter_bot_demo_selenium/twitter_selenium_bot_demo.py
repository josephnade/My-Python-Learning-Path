...
class Twitter:
    ...
    def search_hashtag(self, hashtag, how_many_tweet):
        ...
        while True:
            ...
            tweet = self.driver.find_elements(By.XPATH,
                                              './/article[@data-testid="tweet"]/div/div/div/div[2]/div[2]/div[2]/div[1]/div')
...
while True:
    ...
    if choose == "2":
        ...
        hashtag = input("What hashtag do you want to search:")
        how_many_tweet = int(input("How many tweet do you want to see:"))
        twitter.search_hashtag(hashtag, how_many_tweet)
    else:
